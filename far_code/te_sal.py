...
for count, i in enumerate(all_sheets):
    all_sheets[count] = i[(i['position'] == "TE")]

for count, i in enumerate(all_sheets):
    all_sheets[count] = i.drop_duplicates(subset=['player'])

for count, i in enumerate(all_sheets):
    all_sheets[count] = i.sort_values(['team_name', 'snap_counts_block'], ascending=[True, False]).groupby('team_name').head(2)
...
# running.to_csv(f"te_running.csv", index=False) ##

################

sal_cols = ['player-name', 'year signed', 'age', 'year 2', 'value', 'average/year']
sal_2007 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2007.csv", usecols=sal_cols)
sal_2008 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2008.csv", usecols=sal_cols)
sal_2009 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2009.csv", usecols=sal_cols)
sal_2010 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2010.csv", usecols=sal_cols)
sal_2011 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2011.csv", usecols=sal_cols)
sal_2012 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2012.csv", usecols=sal_cols)
sal_2013 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2013.csv", usecols=sal_cols)
sal_2014 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2014.csv", usecols=sal_cols)
sal_2015 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2015.csv", usecols=sal_cols)
sal_2016 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2016.csv", usecols=sal_cols)
sal_2017 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2017.csv", usecols=sal_cols)
sal_2018 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2018.csv", usecols=sal_cols)
sal_2019 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2019.csv", usecols=sal_cols)
sal_2020 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2020.csv", usecols=sal_cols)
sal_2021 = pd.read_csv("/Users/iangatlin/Desktop/6.s079_project/salary/te/te2021.csv", usecols=sal_cols)
...
salary["year signed"] = salary["year signed"].replace(to_replace=r'([0-9]{4})-([0-9]*) \(FA: [0-9]*\)', value=r'\1', regex=True)
...
salary["player_name"] = salary["player_name"].replace(to_replace=r'Irv Smith', value=r'Irv Smith Jr.', regex=True)
salary["player_name"] = salary["player_name"].replace(to_replace=r'Seth Devalve', value=r'Seth DeValve', regex=True)
...
avg = full.copy()
# avg.to_csv(f"te_test.csv", index=False) ##
...
average.to_csv(f"te_something.csv", index=False) ##

teams = average.copy()
end = teams.groupby(['team_name', 'Year'], as_index=False).agg(avg_diff_te=('diff', 'mean'))
end.to_csv(f'/Users/iangatlin/Desktop/6.s079_project/final/te_end.csv', index=False) ##
